<template>
    <section>
        ...
        <!--列表-->
        <el-table :data="role" highlight-current-row v-loading="listLoading" @row-click="rowClick"
                  @selection-change="selsChange" style="width: 100%;">
            <el-table-column type="selection" width="60">
            </el-table-column>
            <el-table-column type="index" width="60">
            </el-table-column>
                <el-table-column prop="id" label="角色编号" min-width="10%" sortable>
                </el-table-column>
                <el-table-column prop="sn" label="角色标识(唯一)" min-width="10%" sortable>
                </el-table-column>
                <el-table-column prop="name" label="角色名称" min-width="10%" sortable>
                </el-table-column>
        ...
        <el-dialog title="编辑" v-model="formVisible" :close-on-click-modal="false">
            <el-form :model="form" label-width="80px" :rules="formRules" ref="form">
                    ...
                    <el-form-item label="角色标识(唯一)" prop="sn">
    ...
    export default {
        ...
        methods: {
            ...
            getDictionariesDir() {
                ...
                this.$http.post("/common/role/json", params).then((res) => {
            ...
            handleDel: function (row) {
                this.$confirm('确认删除该记录吗?', '提示', {
                    ...
                    this.listLoading = true;
                    this.$http.delete("/common/role/delete/" + row.id).then((res) => {
                        this.listLoading = false;
                        if (res.data.success) {
                            this.$message({
                                message: '删除成功!',
                ...
                this.$refs.form.validate((valid) => {
                    if (valid) {
                        ...
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            this.$http.post("/common/role/save", params).then((res) => {
            ...
            batchRemove: function () {
                ...
                this.$confirm('确认删除选中记录吗？', '提示', {
                    ...
                    this.listLoading = true;
                    //NProgress.start();
                    this.$http.delete("/common/role/deleteBatches/" + ids).then((res) => {
                        this.listLoading = false;
                        if (res.data.success) {
                            this.$message({
                                message: '删除成功!',
