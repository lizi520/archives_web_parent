<template>
    <section>
        ...
        <!--列表-->
        <el-table :data="dictionariesDir" highlight-current-row v-loading="listLoading" @row-click="rowClick"
            ...
            <el-table-column prop="sn" label="标识" min-width="15%" sortable>
            </el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                editLoading: false,
                curentRow: null,
                tags:[{ text:'在使用',label: '在使用', value: 0 ,color:'success'}, { text:'已废弃',label: '已废弃', value: -1,color:'danger'}],
                formRules: {
                    name: [
        ...
        methods: {
            ...
            getDictionariesDir() {
                ...
                this.$http.post("/common/dictionariesDir/json", params).then((res) => {
                    this.total = res.data.total;
                    this.dictionariesDir = res.data.rows;
            ...
            handleDel: function (row) {
                this.$confirm('确认删除该记录吗?', '提示', {
                    ...
                    this.listLoading = true;
                    this.$http.delete("/common/dictionariesDir/delete/"+row.id).then((res) => {
                        this.listLoading = false;
                        if(res.data.success){
                            this.$message({
                                message: '删除成功!',
                ...
                this.$refs.form.validate((valid) => {
                    if (valid) {
                        ...
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            this.$http.post("/common/dictionariesDir/save",params).then((res) => {
            ...
            batchRemove: function () {
                ...
                this.$confirm('确认删除选中记录吗？', '提示', {
                    ...
                    this.listLoading = true;
                    //NProgress.start();
                    this.$http.delete("/common/dictionariesDir/deleteBatches/"+ids).then((res) => {
                        this.listLoading = false;
                        if(res.data.success){
                            this.$message({
                                message: '删除成功!',
