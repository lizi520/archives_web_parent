<template>
    <section>
        ...
        <!--列表-->
        <el-table :data="resources" highlight-current-row v-loading="listLoading" @row-click="rowClick"
                  @selection-change="selsChange" style="width: 100%;">
            <el-table-column type="selection" width="60">
            </el-table-column>
            <el-table-column type="index" width="60">
            </el-table-column>
                <el-table-column prop="id" label="资源编号" min-width="10%" sortable>
                </el-table-column>
                <el-table-column prop="name" label="资源名称" min-width="10%" sortable>
                </el-table-column>
                <el-table-column prop="path" label="资源路径" min-width="10%" sortable>
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getDictionariesDir() {
                ...
                this.$http.post("/common/resources/json", params).then((res) => {
            ...
            handleDel: function (row) {
                this.$confirm('确认删除该记录吗?', '提示', {
                    ...
                    this.listLoading = true;
                    this.$http.delete("/common/resources/delete/" + row.id).then((res) => {
                        this.listLoading = false;
                        if (res.data.success) {
                            this.$message({
                                message: '删除成功!',
                ...
                this.$refs.form.validate((valid) => {
                    if (valid) {
                        ...
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            this.$http.post("/common/resources/save", params).then((res) => {
            ...
            batchRemove: function () {
                ...
                this.$confirm('确认删除选中记录吗？', '提示', {
                    ...
                    this.listLoading = true;
                    //NProgress.start();
                    this.$http.delete("/common/resources/deleteBatches/" + ids).then((res) => {
                        this.listLoading = false;
                        if (res.data.success) {
                            this.$message({
                                message: '删除成功!',
